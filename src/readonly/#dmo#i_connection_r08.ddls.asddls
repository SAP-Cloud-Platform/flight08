@AbapCatalog.sqlViewName: '/DMO/ICONNE_R08'
...
define view /DMO/I_Connection_R08
  as select from /dmo/connecti_08 as Connection

  association [1..*] to /DMO/I_Flight_R08 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier08  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport08',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
