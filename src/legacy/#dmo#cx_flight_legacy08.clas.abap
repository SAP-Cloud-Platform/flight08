CLASS /dmo/cx_flight_legacy08 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_08',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_08',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id08 OPTIONAL
        booking_id            TYPE /dmo/booking_id08 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id08 OPTIONAL
        agency_id             TYPE /dmo/agency_id08 OPTIONAL
        customer_id           TYPE /dmo/customer_id08 OPTIONAL
        carrier_id            TYPE /dmo/carrier08-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_08-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_08-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date08 OPTIONAL
        end_date              TYPE /dmo/end_date08 OPTIONAL
        booking_date          TYPE /dmo/booking_date08 OPTIONAL
        flight_date           TYPE /dmo/flight_date08 OPTIONAL
        status                TYPE /dmo/travel_status08 OPTIONAL
        currency_code         TYPE /dmo/currency_code08 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id08,
          mv_booking_id            TYPE /dmo/booking_id08,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id08,
          mv_agency_id             TYPE /dmo/agency_id08,
          mv_customer_id           TYPE /dmo/customer_id08,
          mv_carrier_id            TYPE /dmo/carrier08-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_08-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_08-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date08,
          mv_end_date              TYPE /dmo/end_date08,
          mv_booking_date          TYPE /dmo/booking_date08,
          mv_flight_date           TYPE /dmo/flight_date08,
          mv_status                TYPE /dmo/travel_status08,
          mv_currency_code         TYPE /dmo/currency_code08,
...
CLASS /dmo/cx_flight_legacy08 IMPLEMENTATION.
