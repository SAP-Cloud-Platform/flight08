...
INTERFACE /dmo/if_flight_legacy08
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL08
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel08     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING08
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking08    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_08
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_08 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT08
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight08 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id08.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id08.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL08, /DMO/BOOKING08, /DMO/BOOK_SUP_08 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code08.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code08,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status08,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel08_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id08.
  INCLUDE TYPE /dmo/booking08_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id08.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id08.
  INCLUDE TYPE /dmo/book_sup_08_data.
