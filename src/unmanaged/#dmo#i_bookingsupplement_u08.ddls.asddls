@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U08'
...
define view /DMO/I_BookingSupplement_U08
  as select from /dmo/book_sup_08 as BookingSupplement

  association        to parent /DMO/I_Booking_U08  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement08     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement08Text08 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT08', element: 'SupplementID' },
